...
-- Valid insert
INSERT INTO Activities(userId, activityDate, description, distance)
VALUES (1, '2022-09-01', 'IUT -> RU', 5.0);

-- Invalid inserts
-- Invalid description length
INSERT INTO Activities(userId, activityDate, description, distance)
VALUES (1, '2022-09-01', '', 5.0);

-- Invalid distance
INSERT INTO Activities(userId, activityDate, description, distance)
VALUES (1, '2022-09-01', 'IUT -> RU', -1);

-- User does not exist
INSERT INTO Activities(userId, activityDate, description, distance)
VALUES (2, '2022-09-01', 'IUT -> RU', 5.0);
